...
/* harmony import */ var _model_points_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/points.js */ "./src/model/points.js");
  ...
  getPoints() {
    if (Provider.isOnline()) {
      return this._api.getPoints()
        .then((points) => {
          const items = createStoreStructure(points.map(_model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer));
    ...
    return Promise.resolve(storePoints.map(_model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  updatePoint(point) {
    if (Provider.isOnline()) {
      return this._api.updatePoint(point)
        .then((updatedPoint) => {
          this._storePoints.setItem(updatedPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(updatedPoint));
          return updatedPoint;
        });
    }

    this._storePoints.setItem(point.id, _model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(Object.assign({}, point)));
  ...
  addPoint(point) {
    if (Provider.isOnline()) {
      return this._api.addPoint(point)
        .then((newPoint) => {
          this._storePoints.setItem(newPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(newPoint));
          return newPoint;
        });
    }
    ...
    this._storePoints.setItem(localNewPoint.id, _model_points_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(localNewPoint));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: TRIP_POINTS_MAP, TRIP_POINT_TRANSFER_TYPES, TRIP_POINT_ACTIVITIES_TYPE, OFFER_TYPE, SortType, UserAction, UpdateType, FilterType, MenuItem, TagName, State */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_POINTS_MAP", function() { return TRIP_POINTS_MAP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_POINT_TRANSFER_TYPES", function() { return TRIP_POINT_TRANSFER_TYPES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_POINT_ACTIVITIES_TYPE", function() { return TRIP_POINT_ACTIVITIES_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OFFER_TYPE", function() { return OFFER_TYPE; });
...
const TRIP_POINTS_MAP = new Map([[`taxi`, `to`], [`bus`, `to`], [`train`, `to`], [`ship`, `to`], [`transport`, `to`],
  [`drive`, `to`], [`flight`, `to`], [`check-in`, `in`], [`sightseeing`, `in`], [`restaurant`, `in`]]);
const TRIP_POINT_TRANSFER_TYPES = [`taxi`, `bus`, `train`, `ship`, `transport`, `drive`, `flight`];
const TRIP_POINT_ACTIVITIES_TYPE = [`check-in`, `sightseeing`, `restaurant`];
const OFFER_TYPE = [`taxi`, `bus`, `train`, `ship`, `transport`, `drive`, `flight`, `check-in`, `sightseeing`, `restaurant`];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_board__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/board */ "./src/presenter/board.js");
...
const api = new _api_index__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);
const storePoints = new _api_store__WEBPACK_IMPORTED_MODULE_2__["default"](StoreType.POINTS + `-` + STORE_NAME, window.localStorage);
const storeDestinations = new _api_store__WEBPACK_IMPORTED_MODULE_2__["default"](StoreType.DESTINATIONS + `-` + STORE_NAME, window.localStorage);
const storeOffers = new _api_store__WEBPACK_IMPORTED_MODULE_2__["default"](StoreType.OFFERS + `-` + STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_3__["default"](api, storePoints, storeDestinations, storeOffers);

const boardPresenter = new _presenter_board__WEBPACK_IMPORTED_MODULE_0__["default"](apiWithProvider);
...
class Destination extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._destinations = [];
  }
...
/* harmony import */ var _view_main_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/main-menu */ "./src/view/main-menu.js");
/* harmony import */ var _model_points__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/points */ "./src/model/points.js");
/* harmony import */ var _model_destination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/destination */ "./src/model/destination.js");
/* harmony import */ var _model_offers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/offers */ "./src/model/offers.js");
/* harmony import */ var _model_filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/filter */ "./src/model/filter.js");
/* harmony import */ var _trip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./trip */ "./src/presenter/trip.js");
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filter */ "./src/presenter/filter.js");
/* harmony import */ var _view_statistics__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/statistics */ "./src/view/statistics.js");
...
/* harmony import */ var _trip_main_info__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./trip-main-info */ "./src/presenter/trip-main-info.js");
...
class Board {
  constructor(api) {
    this._api = api;
    this._currentMenuItem = _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE;
    this._handleSiteMenuClick = this._handleSiteMenuClick.bind(this);
    this._statisticsComponent = null;
  }

  init() {
    this._pointsModel = new _model_points__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._destinationsModel = new _model_destination__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._offersModel = new _model_offers__WEBPACK_IMPORTED_MODULE_3__["default"]();

    this._api.getPoints()
      .then((points) => {
        this._pointsModel.setPoints(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, points);
      })
      .catch(() => {
        this._pointsModel.setPoints(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, []);
      });

    this._api.getDestinations()
      .then((destinations) => {
        this._destinationsModel.setDestinations(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MINOR, destinations);
      })
      .catch(() => {
        this._destinationsModel.setDestinations(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MINOR, []);
      });

    this._api.getOffers()
      .then((offers) => {
        this._offersModel.setOffers(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MINOR, offers);
      })
      .catch(() => {
        this._offersModel.setOffers(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MINOR, []);
      });
  ...
  _renderBoard() {
    ...
    this._mainMenuElement = new _view_main_menu__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._siteTripControlsElement = this._siteTripMainElement.querySelector(`.trip-controls`);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteTripControlsElement, this._mainMenuElement.getElement(), _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._siteTripControlsElement, this._mainMenuElement.getHeading(), _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);

    this._tripMainInfoPresenter = new _trip_main_info__WEBPACK_IMPORTED_MODULE_10__["default"](this._siteTripMainElement, this._pointsModel);
    this._tripMainInfoPresenter.init();

    this._mainMenuElement.setMainMenuClickHandler(this._handleSiteMenuClick);

    this._filterModel = new _model_filter__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    this._tripPresenter = new _trip__WEBPACK_IMPORTED_MODULE_5__["default"](this._siteTripEventsElement, this._siteTripMainElement, this._api, this._pointsModel, this._filterModel, this._destinationsModel, this._offersModel);
    this._filterPresenter = new _filter__WEBPACK_IMPORTED_MODULE_6__["default"](this._siteTripControlsElement, this._filterModel, this._pointsModel);
    ...
    document.querySelector(`.trip-main__event-add-btn`).addEventListener(`click`, (evt) => {
      evt.preventDefault();
      if (this._currentMenuItem !== _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE) {
        this._currentMenuItem = _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE;
        this._tripPresenter.init();
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._statisticsComponent);

        this._mainMenuElement.getElement().querySelector(`[data-name=${_const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATS}]`).classList.remove(`trip-tabs__btn--active`);
        this._mainMenuElement.getElement().querySelector(`[data-name=${_const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE}]`).classList.add(`trip-tabs__btn--active`);
      }
  ...
  _handleSiteMenuClick(menuItem) {
    switch (menuItem) {
      case _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE:
        if (this._currentMenuItem !== _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE) {
          this._currentMenuItem = _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE;
          this._tripPresenter.init();
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._statisticsComponent);
        ...
        break;
      case _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATS:
        if (this._currentMenuItem !== _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATS) {
          this._currentMenuItem = _const__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATS;
          this._tripPresenter.destroy();
          this._statisticsComponent = new _view_statistics__WEBPACK_IMPORTED_MODULE_7__["default"](this._pointsModel.getPoints());
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._sitePageMainElement.querySelector(`.page-body__container`), this._statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
        }
        break;
    }
  }
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filters_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter, this._pointsModel.getPoints().slice());
    this._filterComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);

    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent.getHeading(), _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR, filterType);
  }
}
...
/* harmony import */ var _view_trip_point_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-point-edit */ "./src/view/trip-point-edit.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class PointNew {
  ...
  init() {
    ...
    this._tripPointEditComponent = new _view_trip_point_edit__WEBPACK_IMPORTED_MODULE_0__["default"](null, this._destinations, this._offers);
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._tripPointEditComponent);
...
/***/ "./src/presenter/trip-main-info.js":
/*!*****************************************!*\
  !*** ./src/presenter/trip-main-info.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _view_trip_main_info__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-main-info */ "./src/view/trip-main-info.js");
...
class TripMainInfo {
  ...
  init() {
    ...
    this._tripMainInfo = new _view_trip_main_info__WEBPACK_IMPORTED_MODULE_1__["default"](this._pointsModel.getPoints().slice());

    if (prevTripMainInfoComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripMainInfoContainer, this._tripMainInfo, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._tripMainInfo, prevTripMainInfoComponent);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevTripMainInfoComponent);
  }
...
/* harmony import */ var _view_trip_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-point */ "./src/view/trip-point.js");
/* harmony import */ var _view_trip_point_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-point-edit */ "./src/view/trip-point-edit.js");
...
class TripPoint {
  ...
  init(tripPoint) {
    ...
    this._tripPointComponent = new _view_trip_point__WEBPACK_IMPORTED_MODULE_0__["default"](tripPoint);
    this._tripPointEditComponent = new _view_trip_point_edit__WEBPACK_IMPORTED_MODULE_1__["default"](tripPoint, this._destinations, this._offers);
    ...
    if (prevTripPointComponent === null || prevTripPointEditComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._tripPointsContainer, this._tripPointComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripPointComponent, prevTripPointComponent);
    }

    if (this._mode === Mode.EDITING) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripPointEditComponent, prevTripPointEditComponent);
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevTripPointComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevTripPointEditComponent);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._tripPointComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._tripPointEditComponent);
  }
  ...
  setViewState(state) {
    ...
    switch (state) {
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["State"].SAVING:
        this._tripPointEditComponent.updateData({
          isDisabled: true,
          isSaving: true
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["State"].DELETING:
        this._tripPointEditComponent.updateData({
          isDisabled: true,
          isDeleting: true
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["State"].ABORTING:
  ...
  _replaceCardToForm() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripPointEditComponent, this._tripPointComponent);
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._changeMode();
  ...
  _replaceFormToCard() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripPointComponent, this._tripPointEditComponent);
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
    this._mode = Mode.DEFAULT;
  }
...
/* harmony import */ var _view_sort_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/sort-menu */ "./src/view/sort-menu.js");
/* harmony import */ var _view_day__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/day */ "./src/view/day.js");
/* harmony import */ var _view_trip_days_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/trip-days-list */ "./src/view/trip-days-list.js");
/* harmony import */ var _view_trip_events_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/trip-events-list */ "./src/view/trip-events-list.js");
/* harmony import */ var _view_point_list_element__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/point-list-element */ "./src/view/point-list-element.js");
...
/* harmony import */ var _trip_point__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./trip-point */ "./src/presenter/trip-point.js");
/* harmony import */ var _point_new__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./point-new */ "./src/presenter/point-new.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
class Trip {
  constructor(tripContainer, siteTripMainElement, api, pointsModel, filterModel, destinationsModel, offersModel) {
    ...
    this._noTripPointsComponent = new _view_no_points__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._loadingComponent = new _view_loading__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._sortMenuComponent = null;
    this._tripDaysList = new _view_trip_days_list__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(this._tripDaysList);
  ...
  _getTasks() {
    ...
    const filteredPoints = _utils_filter_js__WEBPACK_IMPORTED_MODULE_10__["filter"][filterType](points);

    switch (this._currentSortType) {
      case _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].TIME:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_11__["sortByDate"]);
      case _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].EVENT:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_11__["sortByEvent"]);
      case _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].PRICE:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_11__["sortByPrice"]);
    }
  ...
  _renderBoard() {
    this._pointNewPresenter = new _point_new__WEBPACK_IMPORTED_MODULE_8__["default"](this._tripContainer, this._handleViewAction, this._siteTripMainElement, this._getOffers(), this._getDestinations());
    ...
    if (this._currentSortType === null) {
      this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].EVENT;
    }

    if (tripPoints.length === 0) {
      this._renderNoTripPoints();
    } else {
      this._sortMenuComponent = new _view_sort_menu__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
  ...
  _clearBoard({resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(this._sortMenuComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(this._noTripPointsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(this._loadingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["remove"])(this._tripDaysList);
  ...
  _renderNoTripPoints() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(this._tripContainer, this._noTripPointsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(this._tripContainer, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].AFTERBEGIN);
  }
  ...
  _renderSortMenu() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(this._tripContainer, this._sortMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  }

  _renderTripDaysList() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(this._tripContainer, this._tripDaysList, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderTripPoint(siteTripEventsListElement, tripPoint) {
    ...
    const tripPointPresenter = new _trip_point__WEBPACK_IMPORTED_MODULE_7__["default"](siteTripEventsListElement, destinations, offers, this._handleViewAction, this._handleModeChange);
  ...
  _renderDay(numberOfDates, points) {
    ...
    if (numberOfDates !== null) {
      day = new _view_day__WEBPACK_IMPORTED_MODULE_1__["default"](true, numberOfDates, points[0].startDate);
    } else {
      day = new _view_day__WEBPACK_IMPORTED_MODULE_1__["default"](false);
    }
    const tripEventsList = new _view_trip_events_list__WEBPACK_IMPORTED_MODULE_3__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(this._tripDaysList, day, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(day, tripEventsList, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
    points.forEach((tripPoint) => {
      const pointListElement = new _view_point_list_element__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_12__["render"])(tripEventsList, pointListElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_12__["RenderPosition"].BEFOREEND);
  ...
  _renderTripPoints() {
    ...
    if (this._currentSortType !== _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].EVENT) {
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_9__["UserAction"].UPDATE_POINT:
        this._tripPointPresenter[update.id].setViewState(_const__WEBPACK_IMPORTED_MODULE_9__["State"].SAVING);
        this._api.updatePoint(update)
          .then((response) => {
            this._pointsModel.updatePoint(updateType, response);
          })
          .catch(() => {
            this._tripPointPresenter[update.id].setViewState(_const__WEBPACK_IMPORTED_MODULE_9__["State"].ABORTING);
          });
        break;
      ...
      case _const__WEBPACK_IMPORTED_MODULE_9__["UserAction"].DELETE_POINT:
        this._tripPointPresenter[update.id].setViewState(_const__WEBPACK_IMPORTED_MODULE_9__["State"].DELETING);
...
const isPointFuture = (startDate) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_1___default()(currentDate).isBefore(startDate, `day`);
};

const isPointPast = (endDate) => {
  const currentDate = new Date();

  return moment__WEBPACK_IMPORTED_MODULE_1___default()(currentDate).isAfter(endDate, `day`);
};

const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING]: (tasks) => tasks,
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE]: (points) => points.filter((point) => isPointFuture(point.startDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST]: (points) => points.filter((point) => isPointPast(point.endDate))
};
...
/*!****************************!*\
  !*** ./src/utils/point.js ***!
  \****************************/
/*! exports provided: sortByDate, sortByPrice, sortByEvent, formatDatesDifference, getOffersByType, getDestinationByName, isHasTown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortByEvent", function() { return sortByEvent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDatesDifference", function() { return formatDatesDifference; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffersByType", function() { return getOffersByType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDestinationByName", function() { return getDestinationByName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isHasTown", function() { return isHasTown; });
const Time = {
  HOURS: 24,
  MINUTES: 60,
  SECONDS: 60,
...
const sortByEvent = (pointA, pointB) => {
  return pointA.startDate - pointB.startDate;
};

const formatDatesDifference = (dateDiff) => {
...
const getDestinationByName = (name, destinations) => {
...
const isHasTown = (town, destinations) => {
  for (let i = 0; i < destinations.length; i++) {
...
class Abstract {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this._getTemplate());
    }
...
class Day extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
      ...
      return (
        `<li class="trip-days__item  day">
          <div class="day__info">
            ...
            <time class="day__date" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`YYYY-MM-DD`)}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`MMM DD`)}</time>
          </div>
        </li>`
      );
    }
...
class Filters extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getHeading() {
    return Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createElement"])(`<h2 class="visually-hidden">Filter events</h2>`);
  }
  ...
  _createFilterItemTemplate(filter) {
    ...
    if (type === _const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].EVERYTHING) {
      return (
      ...
      const points = _utils_filter__WEBPACK_IMPORTED_MODULE_3__["filter"][filter.type](this._points);
...
class MainMenu extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  getHeading() {
    return Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createElement"])(`<h2 class="visually-hidden">Switch trip view</h2>`);
  }
  ...
  _createMainMenuTemplate() {
    return (
      `<nav class="trip-controls__trip-tabs  trip-tabs">
        <a class="trip-tabs__btn  trip-tabs__btn--active" data-name="${_const__WEBPACK_IMPORTED_MODULE_2__["MenuItem"].TABLE}" href="#">Table</a>
        <a class="trip-tabs__btn" data-name="${_const__WEBPACK_IMPORTED_MODULE_2__["MenuItem"].STATS}" href="#">Stats</a>
      </nav>`
    );
  }
  ...
  _mainMenuClickHandler(evt) {
    evt.preventDefault();
    if (evt.target.tagName === _const__WEBPACK_IMPORTED_MODULE_2__["TagName"].A) {
      evt.target.classList.add(`trip-tabs__btn--active`);
      if (evt.target.dataset.name === _const__WEBPACK_IMPORTED_MODULE_2__["MenuItem"].TABLE) {
        this.getElement().querySelector(`[data-name=${_const__WEBPACK_IMPORTED_MODULE_2__["MenuItem"].STATS}]`).classList.remove(`trip-tabs__btn--active`);
      } else {
        this.getElement().querySelector(`[data-name=${_const__WEBPACK_IMPORTED_MODULE_2__["MenuItem"].TABLE}]`).classList.remove(`trip-tabs__btn--active`);
      }
...
/***/ "./src/view/point-list-element.js":
/*!****************************************!*\
  !*** ./src/view/point-list-element.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PointListElement; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");


class PointListElement extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _getTemplate() {
...
class SortMenu extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createSortMenuTemplate() {
    return (
      ...
      ${this._currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ?
        `<span class="trip-sort__item  trip-sort__item--day">Day</span>`
        : `<span class="trip-sort__item  trip-sort__item--day"></span>`}

      <div class="trip-sort__item  trip-sort__item--event">
        <input id="sort-event" class="trip-sort__input  visually-hidden" ${this._currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? `checked` : ``} type="radio" name="trip-sort" value="sort-event" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}">
        <label class="trip-sort__btn" for="sort-event">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" ${this._currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? `checked` : ``} type="radio" name="trip-sort" value="sort-time" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}">
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="sort-price" class="trip-sort__input  visually-hidden" ${this._currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? `checked` : ``} type="radio" name="trip-sort" value="sort-price" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}">
  ...
  _sortTypeChangeHandler(evt) {
    if (evt.target.tagName !== _const__WEBPACK_IMPORTED_MODULE_1__["TagName"].INPUT) {
      return;
    }
...
const renderTimeChart = (timeCtx, data) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(timeCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_1___default.a],
    type: `horizontalBar`,
    data: {
      labels: [`🚕 TAXI`, `🚌 BUS`, `🚂  TRAIN`, `🛳 SHIP`, `🚊 TRANSPORT`, `🚗 DRIVE`, `✈ FLIGHT`, `🏨 CHECK-IN`, `🏛 SIGHTSEEING`, `🍽 RESTAURANT`],
    ...
    options: {
      plugins: {
        datalabels: {
          ...
          anchor: `end`,
          align: `start`,
          formatter: (val) => `${Object(_utils_point__WEBPACK_IMPORTED_MODULE_3__["formatDatesDifference"])(val)}`
        }
      },
      title: {
        display: true,
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _setCharts() {
    ...
    moneyCtx.height = BAR_HEIGHT * _const__WEBPACK_IMPORTED_MODULE_4__["OFFER_TYPE"].length;
    transportCtx.height = BAR_HEIGHT * _const__WEBPACK_IMPORTED_MODULE_4__["OFFER_TYPE"].length;
    timeCtx.height = BAR_HEIGHT * _const__WEBPACK_IMPORTED_MODULE_4__["OFFER_TYPE"].length;
...
class TripDaysList extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _getTemplate() {
    return this._createTripDaysList();
  }
...
class TripMainInfo extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _generateTitle(tripPoints) {
    const sortedTripPoints = tripPoints.slice().sort(_utils_point__WEBPACK_IMPORTED_MODULE_1__["sortByEvent"]);
  ...
  _generateDate(tripPoints) {
    ...
    if (sortedTripPoints.length !== 0) {
      return moment__WEBPACK_IMPORTED_MODULE_2___default()(sortedTripPoints[0].startDate).format(`D MMM`) + ` — ` +
        moment__WEBPACK_IMPORTED_MODULE_2___default()(sortedTripPoints[sortedTripPoints.length - 1].endDate).format(`D MMM`);
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripPointEdit; });
...
const createEventActivityBlock = (tripPoint) => {
  ...
  for (let i = 0; i < _const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINT_ACTIVITIES_TYPE"].length; i++) {
    const type = _const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINT_ACTIVITIES_TYPE"][i];
    block +=
...
const createEventTransferBlock = (tripPoint) => {
  let block = ``;
  for (let i = 0; i < _const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINT_TRANSFER_TYPES"].length; i++) {
    const type = _const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINT_TRANSFER_TYPES"][i];
    block +=
      `<div class="event__type-item">
        <input id="event-type-${type}-${tripPoint.id}" class="event__type-input  visually-hidden" type="radio" name="event-type" value="${type}" ${tripPoint.tripPointType === type ? `checked` : ``}>
        <label class="event__type-label  event__type-label--${type}" for="event-type-${type}-${tripPoint.id}">${type[0].toUpperCase() + type.slice(1)}</label>
...
class TripPointEdit extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setDatePickers() {
    ...
    if (this._data.startDate) {
      this._datepickerStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
  ...
  _generateDefaultPoint() {
    return {
      ...
      startDate: new Date(),
      endDate: new Date(),
      offers: Object(_utils_point__WEBPACK_IMPORTED_MODULE_5__["getOffersByType"])(`bus`, this._offers),
      cost: 0,
      isFavorite: false,
    };
  }
  ...
  _createTripPointEditTemplate(tripPoint) {
    ...
    if (this._destinations && Object(_utils_point__WEBPACK_IMPORTED_MODULE_5__["isHasTown"])(tripPoint.destination.name, this._destinations)) {
      ...
      `<form class="event trip-events__item event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            <label class="event__label  event__type-output" for="event-destination-${tripPoint.id}">
              ${tripPoint.tripPointType[0].toUpperCase() + tripPoint.tripPointType.slice(1)} ${_const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINTS_MAP"].get(tripPoint.tripPointType)}
            </label>
        ...
        if (tripPoint.destination.name === destination.name) {
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-${tripPoint.id}" type="text" name="event-start-time" value="${moment__WEBPACK_IMPORTED_MODULE_3___default()(tripPoint.startDate).format()}" ${this._data.isDisabled ? `disabled` : ``} required>
            —
            <label class="visually-hidden" for="event-end-time-${tripPoint.id}">
              To
            </label>
            <input class="event__input  event__input--time" id="event-end-time-${tripPoint.id}" type="text" name="event-end-time" value="${moment__WEBPACK_IMPORTED_MODULE_3___default()(tripPoint.endDate).format()}" ${this._data.isDisabled ? `disabled` : ``} required>
          </div>
  ...
  _destinationInputHandler(evt) {
    evt.preventDefault();
    const destination = Object(_utils_point__WEBPACK_IMPORTED_MODULE_5__["getDestinationByName"])(evt.target.value, this._destinations);

    if (Object(_utils_point__WEBPACK_IMPORTED_MODULE_5__["isHasTown"])(evt.target.value, this._destinations)) {
      this.updateData({
        destination: {
  ...
  _typeNameRadioHandler(evt) {
    this.updateData({
      ...
      offers: Object(_utils_point__WEBPACK_IMPORTED_MODULE_5__["getOffersByType"])(evt.target.value, this._offers)
    });
  }
...
class TripPoint extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createTripPointTemplate(tripPoint) {
    ...
    const dateDiffString = Object(_utils_point__WEBPACK_IMPORTED_MODULE_3__["formatDatesDifference"])(tripPoint.endDate - tripPoint.startDate);
    ...
    return (
      ...
      <div class="event">
        ...
        <h3 class="event__title">${tripPoint.tripPointType[0].toUpperCase() + tripPoint.tripPointType.slice(1)} ${_const__WEBPACK_IMPORTED_MODULE_1__["TRIP_POINTS_MAP"].get(tripPoint.tripPointType)} ${tripPoint.destination.name}</h3>

        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time"
            datetime="${moment__WEBPACK_IMPORTED_MODULE_2___default()(tripPoint.startDate).format()}">
              ${startHours}:${startMinutes}</time>
            &mdash;
            <time class="event__end-time"
            datetime="${moment__WEBPACK_IMPORTED_MODULE_2___default()(tripPoint.endDate).format()}">
