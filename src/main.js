...
/*
const createAddEventWithDestination = () => {
  return (
...
const createAddEventWithoutDestination = () => {
  return (
    `<form class="trip-events__item  event  event--edit" action="#" method="post">
      <header class="event__header">
        <div class="event__type-wrapper">
...
render(siteTripInfoElement, createTotalCostTemplate(), `beforeend`);
...
render(siteTripEventsElement, createSortByTemplate(), `beforeend`);
...
render(siteTripEventsListElement, createTripEditTemplate(), `beforeend`);
